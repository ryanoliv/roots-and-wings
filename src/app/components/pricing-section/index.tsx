...
export default function PricingSection() {
  return (
    <section className="container mx-auto px-4 flex flex-col gap-10 items-center">
      <div className="flex flex-col items-center text-center gap-4">
        <h2>Invest in your child’s potential</h2>
        <p className="italic max-w-3xl" style={{ opacity: 0.8 }}>
          &ldquo;We aren&apos;t just tutoring. We are building the foundations
          your child will stand on for the rest of their life.&rdquo;
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl justify-center">
        ...
        >
          ...
          >
            <h3 className="text-2xl font-bold" style={{ color: "inherit" }}>
          ...
          <div className="pt-2 flex flex-col flex-grow">
            <PricingRow
              title="Starter Block"
              price="£320"
              feature="4-week introduction"
            />
            <PricingRow
              title="Confidence Builder"
              price="£640"
              feature="8 weeks · most popular"
            />
            <PricingRow
              title="Tutoring Programme"
              price="£1,200"
              feature="12 weeks · full transformation"
              isLast
            />
          </div>
        </div>
        ...
        >
          ...
          <div className="pt-2 flex flex-col flex-grow">
            <PricingRow
              title="Flex-school support"
              price="£320–480/mo"
              feature="4–6 sessions/month"
            />
            <PricingRow
              title="Homeschool foundation"
              price="£640/mo"
              feature="8 sessions/month"
            />
            <PricingRow
              title="Homeschool full programme"
              price="£960–1,200/mo"
              feature="12-15 sessions/month"
              isLast
            />
          </div>
        </div>
      ...
      <div className="text-center">
        <p className="text-sm" style={{ opacity: 0.6 }}>
          * Payment plans available across all programmes. Every journey begins
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1 pr-4">
        <h4 className="font-bold text-lg" style={{ color: "inherit" }}>
          {title}
        </h4>
